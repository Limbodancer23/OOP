...
import isp1.pay.PayWithWebMoney;
import isp1.pay.PayableWithPhone;

public class InternetPaymentService implements PayWithWebMoney, PayableWithPhone, PayWithCreditCard {
    @Override
